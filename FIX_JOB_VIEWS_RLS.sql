...
DROP POLICY IF EXISTS "Allow job view tracking" ON job_views;
DROP POLICY IF EXISTS "Job seekers can view their own job views" ON job_views;
...
-- Allow employers to view analytics for their own jobs (using user_id, not employer_id)
