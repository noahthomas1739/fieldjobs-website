  ...
  const handleEmailLogin = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (error) {
        ...
        console.log('Login successful, checking account type...')
      ...
      <div className="max-w-md w-full space-y-8">
        ...
        <div className="bg-white p-8 rounded-lg shadow-md">
          ...
          <button
            ...
            disabled={isLoading}
            className="w-full flex items-center justify-center gap-3 bg-white border border-gray-300 text-gray-700 px-4 py-3 rounded-lg hover:bg-gray-50 transition-colors disabled:opacity-50 disabled:cursor-not-allowed mb-3"
          >
